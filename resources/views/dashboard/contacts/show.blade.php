        ...
        <div class="toolbar">
            ...
            <div class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <!-- begin :: Title -->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Contacts</h1>
                    <!-- end   :: Title -->
            ...
            <div class="card-body p-0">
                <!-- begin :: Card header -->
                    <div class="card-header d-flex align-items-center">
                        <h3 class="fw-bolder text-dark"> Message Details</h3>
                    </div>
                    <!-- end   :: Card header -->
                    ...
                    <div class="form-footer p-8 text-end">
                        ...
                        <!-- begin :: Submit btn -->
                        <a class="btn btn-primary" href="{{ route('dashboard.contacts.index') }}">
                            Back
                        </a>
                        <!-- end   :: Submit btn -->
