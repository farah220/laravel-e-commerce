        ...
        <div class="card-body p-0">
            ...
            <!-- begin :: Card header -->
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> Edit Product</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="px-8 py-4">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name" placeholder="example" value="{{ old('name') ?? $product->name}}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="description" placeholder="example" value="{{ old('description') ?? $product->description }}">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email_inp" name="price" placeholder="example" value="{{ old('price') ?? $product->price }}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="price_after_discount" placeholder="example" value="{{ old('price_after_discount') ?? $product->price_after_discount}}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="stock_quantity" placeholder="example" value="{{ old('stock_quantity') ?? $product->stock_quantity }}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="sku" placeholder="example" value="{{ old('sku') ?? $product->sku }}">
