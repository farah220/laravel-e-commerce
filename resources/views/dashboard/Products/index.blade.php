        ...
        <div class="card-body pt-0">
            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Price After Discount</th>
                    <th class="min-w-125px">Stock Quantity</th>
                ...
                @forelse($products as $product)
                    <tr>
                        ...
                        <!--begin:: Image -->
                        <td>
                            <img src="{{ asset('storage/Images/Products/' . $product['image']) }}" width="50" height="50" >
                        </td>
                        <!--end:: Image -->
                        <!--begin::Name=-->
                        <td>
                        ...
                        <td>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.products.show',$product) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.products.edit',$product) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
