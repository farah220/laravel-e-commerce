        ...
        <div class="card-body p-0">
            ...
            <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> Category Details</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" disabled name="name" placeholder="example" value="{{ old('name') ?? $category->name}}">
                ...
                <div class="form-footer p-8 text-end">
                    ...
                    <!-- begin :: Submit btn -->
                    <a class="btn btn-primary" href="{{ route('dashboard.categories.index') }}">
                        Back
                    </a>
                    <!-- end   :: Submit btn -->
